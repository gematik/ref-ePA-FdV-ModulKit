...
public class EPA_FdV_AUTHN_CipherReferenceType : NSObject ,EPA_FdV_AUTHN_ISerializableObject
{
    private var  __source:DDXMLNode? = nil
    

    var  Transforms:EPA_FdV_AUTHN_TransformsType_1?
    ...
    public  func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHN_RequestResultHandler)
    {
        ...
        let __TransformsItemElement=__request.writeElement(obj: Transforms, type:EPA_FdV_AUTHN_TransformsType_1.self, name:"Transforms", URI:"http://www.w3.org/2001/04/xmlenc#", parent:__parent, skipNullProperty:true)
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHN_RequestResultHandler ) -> Bool
    {
        if __node.localName=="Transforms"
        {
            ...
            {
                self.Transforms = try! __request.createObject(node: __node, type:EPA_FdV_AUTHN_TransformsType_1.self) as? EPA_FdV_AUTHN_TransformsType_1
            }
            return true;
        }
