...
public class EPA_FdV_AUTHN_X509DataType : NSObject ,EPA_FdV_AUTHN_ISerializableObject
{
    private var  __source:DDXMLNode? = nil
    

    var  X509IssuerSerial:EPA_FdV_AUTHN_X509IssuerSerialType?
    ...
    public  func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHN_RequestResultHandler)
    {
        ...
        let __X509IssuerSerialItemElement=__request.writeElement(obj: X509IssuerSerial, type:EPA_FdV_AUTHN_X509IssuerSerialType.self, name:"X509IssuerSerial", URI:"http://www.w3.org/2000/09/xmldsig#", parent:__parent, skipNullProperty:true)
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHN_RequestResultHandler ) -> Bool
    {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "X509IssuerSerial")
            {
                self.X509IssuerSerial = try! __request.createObject(node: __node, type:EPA_FdV_AUTHN_X509IssuerSerialType.self) as? EPA_FdV_AUTHN_X509IssuerSerialType
            }
            return true;
        }
        if __node.localName=="X509SKI"
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "X509SKI")
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "X509SubjectName")
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "X509Certificate")
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "X509CRL")
            {
