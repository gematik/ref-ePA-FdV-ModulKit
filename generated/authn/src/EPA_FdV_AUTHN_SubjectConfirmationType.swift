...
public class EPA_FdV_AUTHN_SubjectConfirmationType : NSObject ,EPA_FdV_AUTHN_ISerializableObject
{
    ...
    var  SubjectConfirmationData:EPA_FdV_AUTHN_SubjectConfirmationDataType?
    ...
    public func loadWithXml(__node: DDXMLElement, __request:EPA_FdV_AUTHN_RequestResultHandler)
    {
        ...
        if EPA_FdV_AUTHN_Helper.hasAttribute(node: __node, name:"Method", url:"")
        {
            self.Method = EPA_FdV_AUTHN_Helper.getAttribute(node: __node, name:"Method", url:"")!.stringValue!
        }
    }
    ...
    public  func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHN_RequestResultHandler)
    {
        ...
        let __SubjectConfirmationDataItemElement=__request.writeElement(obj: SubjectConfirmationData, type:EPA_FdV_AUTHN_SubjectConfirmationDataType.self, name:"SubjectConfirmationData", URI:"urn:oasis:names:tc:SAML:2.0:assertion", parent:__parent, skipNullProperty:true)
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHN_RequestResultHandler ) -> Bool
    {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "SubjectConfirmationData")
            {
                self.SubjectConfirmationData = try! __request.createObject(node: __node, type:EPA_FdV_AUTHN_SubjectConfirmationDataType.self) as? EPA_FdV_AUTHN_SubjectConfirmationDataType
            }
            return true;
        }
        if __node.localName=="Method"
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "Method")
            {
