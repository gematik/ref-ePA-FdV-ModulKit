...
public class EPA_FdV_AUTHN_SignatureMethodType : NSObject ,EPA_FdV_AUTHN_ISerializableObject
{
    ...
    public  func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHN_RequestResultHandler)
    {
        ...
        {
            __HMACOutputLengthItemElement!.stringValue = EPA_FdV_AUTHN_Helper.getStringFromNumber(number: self.HMACOutputLength!);
        }
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHN_RequestResultHandler ) -> Bool
    {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "HMACOutputLength")
            {
                self.HMACOutputLength = EPA_FdV_AUTHN_Helper.getNumber(stringNumber: __node.stringValue, isDecimal:false)!
            }
            return true;
        }
