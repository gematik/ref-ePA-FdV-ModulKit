...
public class EPA_FdV_AUTHN_EvidenceType : NSObject ,EPA_FdV_AUTHN_ISerializableObject
{
    ...
    var Assertion:[EPA_FdV_AUTHN_AssertionType?]? = []

    var EncryptedAssertion:[EPA_FdV_AUTHN_EncryptedElementType?]? = []
    ...
    public  func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHN_RequestResultHandler)
    {
        ...
        if self.Assertion != nil
        {
            ...
            {
                let __AssertionItemElement=__request.writeElement(obj: __item, type:EPA_FdV_AUTHN_AssertionType.self, name:"Assertion", URI:"urn:oasis:names:tc:SAML:2.0:assertion", parent:__parent, skipNullProperty:false)
        ...
        if self.EncryptedAssertion != nil
        {
            ...
            {
                let __EncryptedAssertionItemElement=__request.writeElement(obj: __item, type:EPA_FdV_AUTHN_EncryptedElementType.self, name:"EncryptedAssertion", URI:"urn:oasis:names:tc:SAML:2.0:assertion", parent:__parent, skipNullProperty:false)
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHN_RequestResultHandler ) -> Bool
    {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "AssertionIDRef")
            {
                if self.AssertionIDRef == nil
                {
                    self.AssertionIDRef = []
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "AssertionURIRef")
            {
                if self.AssertionURIRef == nil
                {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "Assertion")
            {
                if self.Assertion == nil
                {
                    self.Assertion = []
                }
                self.Assertion!.append(try! __request.createObject(node: __node, type:EPA_FdV_AUTHN_AssertionType.self) as? EPA_FdV_AUTHN_AssertionType)
            }
            return true;
        }
        if __node.localName=="EncryptedAssertion"
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "EncryptedAssertion")
            {
                if self.EncryptedAssertion == nil
                {
                    self.EncryptedAssertion = []
                }
                self.EncryptedAssertion!.append(try! __request.createObject(node: __node, type:EPA_FdV_AUTHN_EncryptedElementType.self) as? EPA_FdV_AUTHN_EncryptedElementType)
            }
            return true;
        }
        return false
