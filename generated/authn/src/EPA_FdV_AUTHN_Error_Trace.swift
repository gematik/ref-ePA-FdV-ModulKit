...
public class EPA_FdV_AUTHN_Error_Trace : NSObject ,EPA_FdV_AUTHN_ISerializableObject
{
    ...
    var  Detail:EPA_FdV_AUTHN_Error_Trace_Detail?
    ...
    public  func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHN_RequestResultHandler)
    {
        ...
        {
            __CodeItemElement!.stringValue = EPA_FdV_AUTHN_Helper.getStringFromNumber(number: self.Code);
        }
        ...
        let __DetailItemElement=__request.writeElement(obj: Detail, type:EPA_FdV_AUTHN_Error_Trace_Detail.self, name:"Detail", URI:"http://ws.gematik.de/tel/error/v2.0", parent:__parent, skipNullProperty:true)
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHN_RequestResultHandler ) -> Bool
    {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "Instance")
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "LogReference")
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "CompType")
            {
        ...
        if __node.localName=="Code"
        {
            ...
            {
                self.Code = EPA_FdV_AUTHN_Helper.getNumber(stringNumber: __node.stringValue, isDecimal:false)!
            }
            return true;
        }
        if __node.localName=="Severity"
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "Severity")
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "ErrorType")
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "ErrorText")
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "Detail")
            {
                self.Detail = try! __request.createObject(node: __node, type:EPA_FdV_AUTHN_Error_Trace_Detail.self) as? EPA_FdV_AUTHN_Error_Trace_Detail
            }
            return true;
        }
        return false
