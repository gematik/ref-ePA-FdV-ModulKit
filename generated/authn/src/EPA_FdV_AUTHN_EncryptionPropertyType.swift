...
public class EPA_FdV_AUTHN_EncryptionPropertyType : NSObject ,EPA_FdV_AUTHN_ISerializableObject
{
    ...
    public func loadWithXml(__node: DDXMLElement, __request:EPA_FdV_AUTHN_RequestResultHandler)
    {
        ...
        if EPA_FdV_AUTHN_Helper.hasAttribute(node: __node, name:"Target", url:"")
        {
            self.Target = EPA_FdV_AUTHN_Helper.getAttribute(node: __node, name:"Target", url:"")!.stringValue!
        }
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHN_RequestResultHandler ) -> Bool
    {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "Target")
            {
