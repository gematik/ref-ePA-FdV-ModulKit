...
public class EPA_FdV_AUTHN_AuthnContextType : NSObject ,EPA_FdV_AUTHN_ISerializableObject
{
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHN_RequestResultHandler ) -> Bool
    {
        ...
        {
            var __temp:DDXMLElement?=nil
            __temp=EPA_FdV_AUTHN_Helper.getNode(node: (__node.parent as! DDXMLElement), name:"AuthnContextDecl", index:0)
            if __temp != nil && __temp!.index == __node.index
            {
                self.AuthnContextDecl = __request.getAnyTypeValue(node: __temp!)
                return true
            }
            __temp=EPA_FdV_AUTHN_Helper.getNode(node: (__node.parent as! DDXMLElement), name:"AuthnContextDecl", index:1)
            if __temp != nil && __temp!.index == __node.index
            {
        ...
        if(__node.localName == "AuthnContextDeclRef")
        {
            ...
            __temp=EPA_FdV_AUTHN_Helper.getNode(node: (__node.parent as! DDXMLElement), name:"AuthnContextDeclRef", index:0)
            if __temp != nil && __temp!.index == __node.index
            {
                self.AuthnContextDeclRef = __temp!.stringValue!
                return true
            }
            __temp=EPA_FdV_AUTHN_Helper.getNode(node: (__node.parent as! DDXMLElement), name:"AuthnContextDeclRef", index:1)
            if __temp != nil && __temp!.index == __node.index
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "AuthnContextClassRef")
            {
        ...
        {
            if EPA_FdV_AUTHN_Helper.isValue(node:__node, name: "AuthenticatingAuthority")
            {
                if self.AuthenticatingAuthority == nil
                {
