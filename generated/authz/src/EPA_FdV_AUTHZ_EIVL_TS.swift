...
public class EPA_FdV_AUTHZ_EIVL_TS : EPA_FdV_AUTHZ_SXCM_TS 
{
	...
	*                         actually occurred.
	*/
    var  offset:EPA_FdV_AUTHZ_IVL_PQ?
    ...
    public override func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHZ_RequestResultHandler)
    {
        ...
        let __offsetItemElement=__request.writeElement(obj: offset, type:EPA_FdV_AUTHZ_IVL_PQ.self, name:"offset", URI:"urn:hl7-org:v3", parent:__parent, skipNullProperty:true)
    ...
    public override  func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHZ_RequestResultHandler ) -> Bool
    {
        ...
        if __node.localName=="offset"
        {
            ...
            {
                self.offset = try! __request.createObject(node: __node, type:EPA_FdV_AUTHZ_IVL_PQ.self) as? EPA_FdV_AUTHZ_IVL_PQ
            }
            return true;
        }
