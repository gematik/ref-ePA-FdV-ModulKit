...
public class EPA_FdV_AUTHZ_IVL_PPD_TS : EPA_FdV_AUTHZ_SXCM_PPD_TS 
{
	...
	*/
    var  low:EPA_FdV_AUTHZ_IVXB_PPD_TS=EPA_FdV_AUTHZ_IVXB_PPD_TS()
	...
	*/
    var  high:EPA_FdV_AUTHZ_IVXB_PPD_TS?

    var  high_1:EPA_FdV_AUTHZ_IVXB_PPD_TS?
	...
	* The high limit of the interval.
	*/
    var  high_2:EPA_FdV_AUTHZ_IVXB_PPD_TS?
	...
	*/
    var  center:EPA_FdV_AUTHZ_PPD_TS=EPA_FdV_AUTHZ_PPD_TS()
	...
	*/
    ...
    public override func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHZ_RequestResultHandler)
    {
        ...
        let __lowItemElement=__request.writeElement(obj: low, type:EPA_FdV_AUTHZ_IVXB_PPD_TS.self, name:"low", URI:"urn:hl7-org:v3", parent:__parent, skipNullProperty:false)
        ...
        let __highItemElement=__request.writeElement(obj: high, type:EPA_FdV_AUTHZ_IVXB_PPD_TS.self, name:"high", URI:"urn:hl7-org:v3", parent:__parent, skipNullProperty:true)
        if __highItemElement != nil
        {
            self.high!.serialize(__parent: __highItemElement!, __request: __request);
        }
            
        let __high_1ItemElement=__request.writeElement(obj: high_1, type:EPA_FdV_AUTHZ_IVXB_PPD_TS.self, name:"high", URI:"urn:hl7-org:v3", parent:__parent, skipNullProperty:true)
        ...
        let __high_2ItemElement=__request.writeElement(obj: high_2, type:EPA_FdV_AUTHZ_IVXB_PPD_TS.self, name:"high", URI:"urn:hl7-org:v3", parent:__parent, skipNullProperty:true)
        if __high_2ItemElement != nil
        {
            self.high_2!.serialize(__parent: __high_2ItemElement!, __request: __request);
        }
            
        let __centerItemElement=__request.writeElement(obj: center, type:EPA_FdV_AUTHZ_PPD_TS.self, name:"center", URI:"urn:hl7-org:v3", parent:__parent, skipNullProperty:false)
    ...
    public override  func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHZ_RequestResultHandler ) -> Bool
    {
        ...
        if(__node.localName == "high")
        {
            ...
            if __temp != nil && __temp!.index == __node.index
            {
                self.high = try! __request.createObject(node: __temp!, type:EPA_FdV_AUTHZ_IVXB_PPD_TS.self) as? EPA_FdV_AUTHZ_IVXB_PPD_TS
                return true
            }
            __temp=EPA_FdV_AUTHZ_Helper.getNode(node: (__node.parent as! DDXMLElement), name:"high", index:1)
            if __temp != nil && __temp!.index == __node.index
            {
                self.high_1 = try! __request.createObject(node: __temp!, type:EPA_FdV_AUTHZ_IVXB_PPD_TS.self) as? EPA_FdV_AUTHZ_IVXB_PPD_TS
                return true
            }
            __temp=EPA_FdV_AUTHZ_Helper.getNode(node: (__node.parent as! DDXMLElement), name:"high", index:2)
            if __temp != nil && __temp!.index == __node.index
            {
                self.high_2 = try! __request.createObject(node: __temp!, type:EPA_FdV_AUTHZ_IVXB_PPD_TS.self) as? EPA_FdV_AUTHZ_IVXB_PPD_TS
                return true
            }
        }
        if __node.localName=="low"
        {
            ...
            {
                self.low = try! __request.createObject(node: __node, type:EPA_FdV_AUTHZ_IVXB_PPD_TS.self) as! EPA_FdV_AUTHZ_IVXB_PPD_TS
            }
            return true;
        }
        if __node.localName=="center"
        {
            ...
            {
                self.center = try! __request.createObject(node: __node, type:EPA_FdV_AUTHZ_PPD_TS.self) as! EPA_FdV_AUTHZ_PPD_TS
            }
            return true;
        }
