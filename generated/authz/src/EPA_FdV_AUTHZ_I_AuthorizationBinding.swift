...
open class EPA_FdV_AUTHZ_I_AuthorizationBinding:NSObject
{
    ...
    func createGetAuthorizationKeyRequest(RecordIdentifier:EPA_FdV_AUTHZ_RecordIdentifierType, DeviceID:EPA_FdV_AUTHZ_DeviceIdType?, __request:EPA_FdV_AUTHZ_RequestResultHandler)  -> URLRequest
    {
        ...
        let __requestObj = createRequest(__soapAction: "http://ws.gematik.de/fd/phrs/AuthorizationService/v1.0#GetAuthorizationKey", __request:__request)
        return __requestObj;
    }
