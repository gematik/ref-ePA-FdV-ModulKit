...
public class EPA_FdV_AUTHZ_UC_AllgemeineVersicherungsdatenXML : NSObject ,EPA_FdV_AUTHZ_ISerializableObject
{
    private var  __source:DDXMLNode? = nil
    

    var  Versicherter:EPA_FdV_AUTHZ_UC_AllgemeineVersicherungsdatenXML_Versicherter=EPA_FdV_AUTHZ_UC_AllgemeineVersicherungsdatenXML_Versicherter()
    ...
    public  func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHZ_RequestResultHandler)
    {
        ...
        let __VersicherterItemElement=__request.writeElement(obj: Versicherter, type:EPA_FdV_AUTHZ_UC_AllgemeineVersicherungsdatenXML_Versicherter.self, name:"Versicherter", URI:"http://ws.gematik.de/fa/vsdm/vsd/v5.2", parent:__parent, skipNullProperty:false)
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHZ_RequestResultHandler ) -> Bool
    {
        if __node.localName=="Versicherter"
        {
            ...
            {
                self.Versicherter = try! __request.createObject(node: __node, type:EPA_FdV_AUTHZ_UC_AllgemeineVersicherungsdatenXML_Versicherter.self) as! EPA_FdV_AUTHZ_UC_AllgemeineVersicherungsdatenXML_Versicherter
            }
            return true;
        }
