...
public class EPA_FdV_AUTHZ_GLIST_TS : EPA_FdV_AUTHZ_ANY 
{
	...
	*/
    var  head:EPA_FdV_AUTHZ_TS=EPA_FdV_AUTHZ_TS()
	...
	*/
    ...
    public override func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHZ_RequestResultHandler)
    {
        ...
        let __headItemElement=__request.writeElement(obj: head, type:EPA_FdV_AUTHZ_TS.self, name:"head", URI:"urn:hl7-org:v3", parent:__parent, skipNullProperty:false)
    ...
    public override  func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHZ_RequestResultHandler ) -> Bool
    {
        if __node.localName=="head"
        {
            ...
            {
                self.head = try! __request.createObject(node: __node, type:EPA_FdV_AUTHZ_TS.self) as! EPA_FdV_AUTHZ_TS
            }
            return true;
        }
