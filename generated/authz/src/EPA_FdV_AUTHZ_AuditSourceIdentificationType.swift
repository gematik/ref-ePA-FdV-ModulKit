...
public class EPA_FdV_AUTHZ_AuditSourceIdentificationType : NSObject ,EPA_FdV_AUTHZ_ISerializableObject
{
    private var  __source:DDXMLNode? = nil
    

    var AuditSourceTypeCode:[EPA_FdV_AUTHZ_CodedValueType?]? = []
    ...
    public func loadWithXml(__node: DDXMLElement, __request:EPA_FdV_AUTHZ_RequestResultHandler)
    {
        ...
        if EPA_FdV_AUTHZ_Helper.hasAttribute(node: __node, name:"AuditEnterpriseSiteID", url:"")
        {
            self.AuditEnterpriseSiteID = EPA_FdV_AUTHZ_Helper.getAttribute(node: __node, name:"AuditEnterpriseSiteID", url:"")!.stringValue!
        }
        if EPA_FdV_AUTHZ_Helper.hasAttribute(node: __node, name:"AuditSourceID", url:"")
        {
            self.AuditSourceID = EPA_FdV_AUTHZ_Helper.getAttribute(node: __node, name:"AuditSourceID", url:"")!.stringValue!
        }
    }
    ...
    public  func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHZ_RequestResultHandler)
    {
        ...
        if self.AuditSourceTypeCode != nil
        {
            ...
            {
                let __AuditSourceTypeCodeItemElement=__request.writeElement(obj: __item, type:EPA_FdV_AUTHZ_CodedValueType.self, name:"AuditSourceTypeCode", URI:"http://ws.gematik.de/fa/phrext/v1.0", parent:__parent, skipNullProperty:false)
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHZ_RequestResultHandler ) -> Bool
    {
        ...
        {
            if EPA_FdV_AUTHZ_Helper.isValue(node:__node, name: "AuditSourceTypeCode")
            {
                if self.AuditSourceTypeCode == nil
                {
                    self.AuditSourceTypeCode = []
                }
                self.AuditSourceTypeCode!.append(try! __request.createObject(node: __node, type:EPA_FdV_AUTHZ_CodedValueType.self) as? EPA_FdV_AUTHZ_CodedValueType)
            }
            return true;
        }
        if __node.localName=="AuditEnterpriseSiteID"
        {
            if EPA_FdV_AUTHZ_Helper.isValue(node:__node, name: "AuditEnterpriseSiteID")
            {
        ...
        {
            if EPA_FdV_AUTHZ_Helper.isValue(node:__node, name: "AuditSourceID")
            {
