...
public class EPA_FdV_AUTHZ_EncryptionPropertiesType : NSObject ,EPA_FdV_AUTHZ_ISerializableObject
{
    private var  __source:DDXMLNode? = nil
    

    var EncryptionProperty:[EPA_FdV_AUTHZ_EncryptionPropertyType]? 
    ...
    public  func serialize(__parent:DDXMLElement, __request:EPA_FdV_AUTHZ_RequestResultHandler)
    {
        ...
        if self.EncryptionProperty != nil
        {
            ...
            {
                let __EncryptionPropertyItemElement=__request.writeElement(obj: __item, type:EPA_FdV_AUTHZ_EncryptionPropertyType.self, name:"EncryptionProperty", URI:"http://www.w3.org/2001/04/xmlenc#", parent:__parent, skipNullProperty:false)
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHZ_RequestResultHandler ) -> Bool
    {
        ...
        {
            if EPA_FdV_AUTHZ_Helper.isValue(node:__node, name: "EncryptionProperty")
            {
                if self.EncryptionProperty == nil
                {
                    self.EncryptionProperty = []
                }
                self.EncryptionProperty!.append(try! __request.createObject(node: __node, type:EPA_FdV_AUTHZ_EncryptionPropertyType.self) as! EPA_FdV_AUTHZ_EncryptionPropertyType)
            }
            return true;
        }
