...
public class EPA_FdV_AUTHZ_DSAKeyValueType : NSObject ,EPA_FdV_AUTHZ_ISerializableObject
{
    ...
    public   func loadProperty(__node: DDXMLElement, __request: EPA_FdV_AUTHZ_RequestResultHandler ) -> Bool
    {
        ...
        {
            if EPA_FdV_AUTHZ_Helper.isValue(node:__node, name: "G")
            {
        ...
        {
            if EPA_FdV_AUTHZ_Helper.isValue(node:__node, name: "Y")
            {
        ...
        {
            if EPA_FdV_AUTHZ_Helper.isValue(node:__node, name: "J")
            {
