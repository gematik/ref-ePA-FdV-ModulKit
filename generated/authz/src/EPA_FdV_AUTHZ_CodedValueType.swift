...
public class EPA_FdV_AUTHZ_CodedValueType : NSObject ,EPA_FdV_AUTHZ_ISerializableObject
{
    ...
    public func loadWithXml(__node: DDXMLElement, __request:EPA_FdV_AUTHZ_RequestResultHandler)
    {
        ...
        if EPA_FdV_AUTHZ_Helper.hasAttribute(node: __node, name:"originalText", url:"")
        {
            self.originalText = EPA_FdV_AUTHZ_Helper.getAttribute(node: __node, name:"originalText", url:"")!.stringValue!
        }
    }
