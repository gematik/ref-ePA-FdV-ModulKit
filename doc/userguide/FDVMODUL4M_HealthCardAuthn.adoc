...
(see: https://github.com/gematik/ref-HealthCardAccessKit[HealthCardAccessKit @ *GitHub*])
which usually would be provided by a `CardReaderType`
(see: https://github.com/gematik/ref-CardReaderProvider-ApiKit[CardReaderProvider-ApiKit @ *GitHub*]).
